module validator {
	...
	/////点击开始游戏按钮.lua
	/** @noSelf */
	export let validator_75053991:(this: void, ctrl:_OBJ__gui_ctrl_button, mouse_btn_id:number)=>void = (this: void, ctrl:_OBJ__gui_ctrl_button, mouse_btn_id:number):void => {
		base.send_custom_event(new aaa_5nmb.点击开始游戏按钮(((base.game) as unknown as base.Game)));
	}
