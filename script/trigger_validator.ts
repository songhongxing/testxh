module validator {
	...
	/** @noSelf */
	export let validator_43068806:(this: void, 伤害来源:Unit, 伤害目标:Unit, 伤害类型:string, 是否暴击:boolean, 伤害值:number, 效果节点:EffectParam, 伤害实例:DamageInstance)=>number = (this: void, 伤害来源:Unit, 伤害目标:Unit, 伤害类型:string, 是否暴击:boolean, 伤害值:number, 效果节点:EffectParam, 伤害实例:DamageInstance):number => {
		let 伤害: number = 伤害值;
		let 伤害倍率: number = 1;
		let 暴击伤害: number = 伤害来源.get_ex(单位属性["暴击伤害"], UnitPropertySubType["Final"]);
